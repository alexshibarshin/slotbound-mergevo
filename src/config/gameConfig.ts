...
export const GAME_CONFIG = {
  stage: {
    ...
    startingSpins: 5,
    startingNudges: 1,
    spinsDroppedPerWave: 5,
    nudgesDroppedPerWave: (wave: number) => wave < 4 ? 1 : 2,
  ...
  slotProgression: {
    xpForLevel: (level: number) => 11 + level * 4,
    killXp: { minion: 1, elite: 4, boss: 18 } satisfies Record<EnemyType, number>,
  },
  ...
  enemies: {
    minion: { hp: 300, speed: 5.6, damage: 1, atlasIndex: 1, size: 11 },
    elite: { hp: 1150, speed: 4, damage: 55, atlasIndex: 2, size: 15 },
    boss: { hp: 13500, speed: 1.9, damage: 20, atlasIndex: 3, size: 23 },
  } satisfies Record<EnemyType, { hp: number; speed: number; damage: number; atlasIndex: number; size: number }>,
  waves: [
    { minion: 10, elite: 0, boss: 0, hpMultiplier: { minion: 0.22 }, speedMultiplier: { minion: 0.72 } },
    { minion: 14, elite: 0, boss: 0, hpMultiplier: { minion: 0.32 }, speedMultiplier: { minion: 0.78 } },
    { minion: 18, elite: 0, boss: 0, hpMultiplier: { minion: 0.45 }, speedMultiplier: { minion: 0.84 } },
    { minion: 14, elite: 1, boss: 0, hpMultiplier: { minion: 0.72, elite: 0.3 }, damageMultiplier: { elite: 0.25 } },
    { minion: 18, elite: 1, boss: 0, hpMultiplier: { minion: 0.85, elite: 0.38 }, damageMultiplier: { elite: 0.35 }, speedMultiplier: { minion: 1.02 } },
    { minion: 21, elite: 2, boss: 0, hpMultiplier: { minion: 1, elite: 0.45 }, damageMultiplier: { elite: 0.45 }, speedMultiplier: { minion: 1.06 } },
    { minion: 20, elite: 3, boss: 0, hpMultiplier: { minion: 1.2, elite: 0.55 }, damageMultiplier: { elite: 0.6 }, speedMultiplier: { minion: 1.1 } },
    { minion: 25, elite: 3, boss: 0, hpMultiplier: { minion: 1.45, elite: 0.62 }, damageMultiplier: { elite: 0.75 }, speedMultiplier: { minion: 1.16, elite: 1.03 } },
    { minion: 29, elite: 4, boss: 0, hpMultiplier: { minion: 1.75, elite: 0.72 }, damageMultiplier: { elite: 0.85 }, speedMultiplier: { minion: 1.22, elite: 1.05 } },
    { minion: 10, elite: 2, boss: 1, hpMultiplier: { minion: 2.1, elite: 0.8, boss: 0.68 }, damageMultiplier: { minion: 1.35, elite: 0.85 }, speedMultiplier: { minion: 1.24, elite: 1.05, boss: 1.1 }, bossFirst: true },
  ] as WaveConfig[],
} as const;
